...
const SubmissionList = ({ formSubmissions }) => {
                  ...
                  <Grid container spacing={2}>
                    ...
                    >
                      ...
                      <ButtonS
                        variant="contained"
                        color="primary"
                        onClick={() => alert("Submission Deleted")}
                      >
                        Edit
                      </ButtonS>
                    </Grid>
                    ...
                    <Grid item xs={12}>
                      ...
                      <TableContainer>
                        <Table>
                          ...
                          <TableBody>
                            {submission.salesPerUnit.map((sale, idx) => (
                              <TableRow key={idx}>
                                <TableCell>{sale.country}</TableCell>
                                <TableCell>{sale.unitSales}</TableCell>
                              </TableRow>
                            ))}
                          </TableBody>
                        </Table>
                    ...
                    <Grid item xs={12} sx={{ display: "flex" }}>
                      ...
                      >
                        {submission.locations.map((location, idx) => (
                          <Typography key={idx}>{location} ,</Typography>
                        ))}
                      </Box>
                    </Grid>
                  </Grid>
